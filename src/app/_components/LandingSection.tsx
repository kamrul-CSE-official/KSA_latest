        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            <p className="text-base sm:text-lg md:text-xl text-white/40 mb-8 leading-relaxed font-light tracking-wide max-w-xl mx-auto px-4">
              Naturub always supports humanity. We strive to empower workers and
              staff by providing them with a platform to be heard. This
              application will help you raise your voice, share your ideas, and
          ...
          <Link className="group cursor-pointer" href="/login">
            ...
            >
              Get Start
              <MoveRight className="group-hover:ml-5 transition-all duration-300" />
            </Button>
          </Link>
        </div>
      </div>
